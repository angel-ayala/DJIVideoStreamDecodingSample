...
public class WebRTCClient {
    ...
    public void handleWebRTCMessage(JSONObject message){
        try {
            ...
            Log.d(TAG, "JSONException during WebRTC message : " + e.getMessage());
        }
    }
        ...
        peerConnection.createAnswer(new SimpleSdpObserver() {
            ...
            public void onCreateSuccess(SessionDescription sessionDescription) {
                ...
                try {
                    ...
                    Log.e(TAG, "JSONException answerCall: " + e.getMessage());
                }
            }
    ...
    private void sendMessage(Object message) {
        ...
        try {
            // append peerSocketID to sent data.
            ...
            Log.e(TAG, "JSONException sendMessage: " + e.getMessage());
        }
    }
